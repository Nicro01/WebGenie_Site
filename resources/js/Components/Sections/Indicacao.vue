        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
            ...
            <g id="Character_1_">
                <g>
                    <g>
                        ...
                        <g>
                            <g>
                                <g>
                                    ...
                                    }" d="M268.151,161.31l-5.465-4.477l-37.2,55.888l5.465,4.477
                                    ...
                                    <ellipse transform="matrix(0.5346 -0.8451 0.8451 0.5346 -42.5621 292.2617)" :style="{
                                        fill: config['primary_color'],
                                    }" cx="244.086" cy="184.776" rx="33.607" ry="14.599"/>
                                <g>
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M310.69,190.058c0,0,10.142,56.402,23.912,86.749c11.122,24.512,31.271,64,31.271,64l10.93-4.084
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M328.724,186.995l0.903-0.252c0.18-0.05,0.291-0.181,0.247-0.291l-1.502-3.756
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M301.822,194.485l0.903-0.252c0.18-0.05,0.291-0.181,0.247-0.291l-1.502-3.755
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M315.273,190.74l0.903-0.252c0.18-0.05,0.291-0.181,0.247-0.291l-1.502-3.756
                            c-0.044-0.11-0.227-0.159-0.407-0.109l-0.903,0.251c-0.18,0.05-0.291,0.181-0.247,0.291l1.502,3.755
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M366.018,351.373c-0.052-0.09-0.096-0.189-0.133-0.3c-0.109-0.326-0.002-0.553,0.107-0.686
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M366.754,348.606c-0.044-0.075-0.076-0.151-0.097-0.226c-0.049-0.181-0.068-0.526,0.357-0.806
                        ...
                        <path :style="{
                            fill: config['primary_color'],
                        }" d="M319.029,359.913c-0.78,0-1.507-0.121-1.972-0.472c-0.317-0.24-0.489-0.566-0.513-0.97
            ...
            <g id="Piggy_Bank">
                <g>
                    ...
                    <path :style="{
                        fill: config['primary_color'],
                    }" d="M244.522,243.224c16.069-11,29.528-9.871,34.003-6.667c4.476,3.203-9.735,27.589-9.735,27.589
                    ...
                    <path :style="{
                        fill: config['primary_color'],
                    }" d="M104.893,277.704l-0.913-0.463c2.485-4.897,5.455-9.629,8.827-14.064l0.815,0.619
                        C110.288,268.183,107.351,272.862,104.893,277.704z"/>
                    <path :style="{
                        fill: config['primary_color'],
                    }" d="M100.125,288.983l-0.969-0.332c0.763-2.229,1.628-4.457,2.568-6.619l0.939,0.408
                        C101.734,284.578,100.88,286.779,100.125,288.983z"/>
                    <path :style="{
                        fill: config['primary_color'],
                    }" d="M287.107,316.751c0,49.647-37.376,89.894-91.336,89.894s-97.704-40.247-97.704-89.894
                    ...
                    <path :style="{
                        fill: config['primary_color'],
                    }" d="M167.21,242.398c-17.413-14.417-32.954-15.541-38.384-12.92c-5.43,2.621,8.613,30.895,8.613,30.895
